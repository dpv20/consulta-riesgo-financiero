...
import { esFormatoRutValido, formatearRut } from '../services/rut.js'
import { calcularScore } from '../services/score.js'
import { paramTexto } from '../utils/request.js'

/** Rechaza un RUT con forma inválida antes de evaluar permisos. */
function validarFormatoRut(req: Request, _res: Response, next: NextFunction): void {
  if (!esFormatoRutValido(paramTexto(req, 'rut'))) {
 ...
 */
scoreRouter.get('/:rut', autenticar, validarFormatoRut, autorizarRut, (req, res) => {
